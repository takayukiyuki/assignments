...
public class SubActivity extends Activity implements TextWatcher {
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        //onRestoreInstanceState(Bundle savedInstanceStateでBundlから復帰する
        super.onRestoreInstanceState(savedInstanceState);
        textView.setText(savedInstanceState.getString(defaultText));
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        //onSaveInstanceState(Bundle outState)でBundlに保存
        outState.putString(defaultText,textView.getText().toString());
    }
